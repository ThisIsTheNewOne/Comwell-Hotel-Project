...
const Header: React.FC = () => {
  ...
  return (
    <header className={`grid-edge fixed top-0 flex h-[84px] w-full items-center justify-center transition delay-75 duration-200 ${showLoginContainer ? 'header-login-active' : 'header-default'} pl-14 pr-6 text-black`}>
