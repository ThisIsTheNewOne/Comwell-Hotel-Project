                    ...
                    <div>
                      <div className="flex flex-col gap-y-3">
                        <div className="input input-single relative border-none">
                          <button className="input-button" onClick={toggleCreditCardVisibility}>
                                ...
                                <li>
                                  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="28" fill="none">
                                    ...
                                    <path
                                      ...
                                      clipRule="evenodd"
                                    ></path>
                                    <path fill="#FF5E00" fillRule="evenodd" d="M19.993 19.517a7.223 7.223 0 0 0 2.555-5.516 7.223 7.223 0 0 0-2.555-5.517 7.222 7.222 0 0 0-2.555 5.517c0 2.209.991 4.187 2.555 5.516Z" clipRule="evenodd"></path>
                                    <rect width="39" height="27" x=".5" y=".5" stroke="#E0E0E0" rx="5.5"></rect>
                                  </svg>
                                </li>
                              </ul>
                            ...
                            >
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" className="w-[16px]">
                                <rect></rect>
                                <path fill="#fff" fillRule="evenodd" d="M6.668 10.6 3.134 7.067l-.733.666 3.533 3.534.734.733 7.067-7.067L13 4.2l-6.333 6.4Z" clipRule="evenodd"></path>
                              </svg>
                            </div>
                          </button>
                        </div>
                      ...
                      <div className={showCreditCard ? "creditCardSec my-2 mx-4" : "creditCardSec hidden my-2 mx-4"}>{showCreditCard && <CreditCard onCardValidation={handleCardValidation} />}</div>
                    </div>
                  </li>
                </ul>
              </div>
