...
const SmallRoomOverview: React.FC<SmallRoomOverviewProps> = ({ roomImage, roomSize, roomName, price }) => {
  // All of the state

  return (
    <>
      <li className="roomListLink">
        <button className="input room-selector relative flex w-full flex-col overflow-hidden !p-0 outline-black ring-black lg:flex-row lg:items-stretch">
          <div className="relative h-[200px] w-full lg:h-[242px]">
            <div className="module-richMedia relative block h-full w-full bg-gray-200">
              <img src={roomImage} alt="borupgaard" className="transition-transform group-hover:scale-[1.05] ease-in duration-150 h-full w-full object-cover lazyautosizes ls-is-cached lazyloaded" />
            </div>
          ...
          <div className="relative flex w-full flex-col px-4 pt-2 pb-4 text-left">
            ...
            <span className="text-xs font-regular mb-4 max-h-[32px] ">
              <p>Vores standardværelser er indrettet i moderne, nordisk stil og med stort badeværelse.</p>
            </span>
