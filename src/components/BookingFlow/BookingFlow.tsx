  ...
  return (
    <nav>
      ...
      >
        ...
        {drawerComponent === "selectedRoom" && <SelectRoom id="selectedRoom" setDrawerComponent={setDrawerComponent} /> }
        {drawerComponent === "guestInfo" &&<GuestInfo id="guestInfo" setDrawerComponent={setDrawerComponent} /> }
